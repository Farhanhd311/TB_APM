...
from utils.auth import render_sidebar, is_logged_in, register
...
with center:
        ...
        st.markdown(
            ...
            <div style="text-align:center; margin-bottom:24px;">
                <div style="
                    ...
                    margin-bottom:14px;
                ">📝</div>
                <div class="section-title" style="margin:0; font-size:1.4rem;">{t("auth_register_title", lang)}</div>
                <div class="section-sub" style="margin-top:6px;">{t("auth_register_sub", lang)}</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        f"<div style='text-align:center; color:#4D9E8F; font-size:0.9rem; margin-bottom:8px;'>{t('auth_have_account', lang)}</div>",
        unsafe_allow_html=True,
    )
